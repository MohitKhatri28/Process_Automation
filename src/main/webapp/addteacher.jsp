            ...
            <main class="h-full overflow-y-auto">
            	<form action="<%= request.getContextPath() %>/addTeacher" method=POST>
					...
					<div class="add_teacher" >
                        <label ><b>Teacher's Name:</b></label><br>
                        <input type="text" id="fname" name="full_name"
                            style="border:black; border-width:2px; border-style:solid;"><br>
                        <label ><b>Create Username:</b></label><br>
                        ...
                        <label for="priority"><b>Permanent Teacher:</b></label>
                        <select name="permanent_id" id="priority">
