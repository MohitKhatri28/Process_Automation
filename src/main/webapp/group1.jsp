    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><%= u.getGroup_1_leaderName() %></p>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <!-- Avatar with inset shadow -->
                        <div>
                          <p class="font-semibold"><%= u.getGroup_1_mem_1_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><%= u.getGroup_1_mem_2_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <!-- Avatar with inset shadow -->
                        <div>
                          <p class="font-semibold"><%= u.getGroup_1_mem_3_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <!-- Avatar with inset shadow -->
                        <div>
                          <p class="font-semibold"><%= u.getGroup_1_mem_4_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
          ...
          <form class="form" action="<%= request.getContextPath() %>/title" method="POST">
          	<div class="max-w-2xl px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
