                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><%= u.getGroup_3_leaderName() %></p>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <!-- Avatar with inset shadow -->
                        <div>
                          <p class="font-semibold"><%= u.getGroup_3_mem_1_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><%= u.getGroup_3_mem_2_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <!-- Avatar with inset shadow -->
                        <div>
                          <p class="font-semibold"><%= u.getGroup_3_mem_3_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <!-- Avatar with inset shadow -->
                        <div>
                          <p class="font-semibold"><%= u.getGroup_3_mem_4_Name() %></p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Member
                          </p>
                        </div>
