    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
                ...
                <ul class="mt-6">
                    ...
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                            ...
                            <span class="ml-4">Remove Teacher</span>
                        </a>
                    </li>
				               ...
				               <c:if test="${!condition_1}">
				                	<li class="relative px-6 py-3">
				                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
				                            ...
				                            <span class="ml-4">Print Guide Allotment</span>
				                        </a>
				                    </li>				                	
				                </c:if>	
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
            	<form action="<%= request.getContextPath() %>/removeTeacher" method=POST>
				
					<div>
                        <select name="remove_id">
                            <option disabled="disabled" selected="selected">Remove Teacher</option>
                            ...
                            <%
	                            try{
		                    		...
		                    		ResultSet rs = st.executeQuery("SELECT * FROM teacher WHERE active_id = 1 ORDER BY pref_id;");
